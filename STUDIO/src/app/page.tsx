...
function DashboardContent() {
  const { surgeons, isLoading: surgeonsLoading, selectedSurgeon } = useSurgeons(); 
  ...
  // console.log("DashboardContent: surgeonsLoading:", surgeonsLoading, "surgeons count:", surgeons?.length);
  // console.log("DashboardContent: selectedSurgeon:", selectedSurgeon);
  ...
  return (
    <MainLayout>
      { /* console.log("DashboardContent rendering. surgeonsLoading:", surgeonsLoading) */}
...
function ProtectedDashboard() {
  ...
  // console.log("ProtectedDashboard: authLoading:", authLoading, "user:", user);
  ...
  if (!user) { // If not loading and no user, it means redirect is happening or should have happened.
               // Render minimal or null to avoid errors before redirect.
     return (
      <MainLayout>
        <div className="flex flex-1 justify-center items-center h-[calc(100vh-theme(spacing.16))]">
          <Loader2 className="h-16 w-16 animate-spin text-primary" />
     ...
     ); // Or return null, or a more specific redirecting... message
  }
